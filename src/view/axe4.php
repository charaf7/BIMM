...
<div class="block-container axe">
    <form id="axeForm" method="post" action="<?php echo $this->router->saveAxe(4); ?>">
        <div class="questions">
            <?php foreach ($axe4 as $q){?>
