...
<html>
<head>
    <title>Axe technologie et innovation</title>
    <link rel="stylesheet" href="skin/main.css" />
    <link rel="stylesheet" href="skin/axe.css" />

</head>

<body class="technologie et innovation" data-code="technologie">
<div class="header">
...
<div class="block-container axe">
    <form id="axeForm" method="post" action="<?php echo $this->router->saveAxe(5); ?>">
        <div class="questions">
            <?php foreach ($axe5 as $q){?>
